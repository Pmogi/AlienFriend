...
function Menu.new()
    ...
    menutimer = Timer.new()
    mmt = {pos = {x = 72, y = -200}}
    mmst = {pos = {x = 120, y = 900}}
    Timer.tween(2,mmt, {pos = {y = 150}}, 'out-in-bounce')
    Timer.tween(4,mmst, {pos = {y = 285}}, 'out-in-bounce')
end
...
function Menu.draw()
    ...
    love.graphics.draw(img[3], mmst.pos.x, mmst.pos.y,0,0.4,0.4)
    Suit.draw()
end
